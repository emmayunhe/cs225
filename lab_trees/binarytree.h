...
class BinaryTree
{
    ...
    public:
        ...
        typename BinaryTree<T>::Node* mostLeft(typename BinaryTree<T>::Node * subRoot) const;
        typename BinaryTree<T>::Node* mostRight(typename BinaryTree<T>::Node *subRoot) const;
